...
public class TestRunner
{
  ...
  public TestRunner(DataObject d)
  {
    ...
    argsFileName = CI.getargsFileName();
    testInputFileName = CI.gettestInputFileName();
    inputFileStub = CI.getinputFileStub();
    inputFileName = CI.getinputFileName();
